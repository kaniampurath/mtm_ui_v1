...
const basePlugins = [
  ...
  plugin("pattern-bot-cockpit", "Pattern Bot Cockpit", "ai", "PB", () => `<div class="pattern-bot-tile" data-pattern-bot><div class="widget-loading">Loading Pattern Bot cockpit...</div></div>`, { w: 24, h: 30 }, { description: "Headless Pattern Bot control cockpit reusing RS cache, signals, risk gate, trading monitor, journal, and audited command controls.", permissions: ["market:read", "signals:read", "risk:read", "trading:read"], refresh_mode: "cache", adapter_key: "mtm.pattern_bot.cockpit", min_size: { w: 18, h: 22 } }),
